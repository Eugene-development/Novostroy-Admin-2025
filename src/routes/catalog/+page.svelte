<section class="bg-gray-50 py-3 sm:py-5">
    <div class="mx-auto max-w-screen-2xl px-4 lg:px-12">
        ...
        <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
            ...
            <div class="flex flex-col-reverse md:flex-row items-start md:items-center justify-between md:space-x-4 p-4 border-b ">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 ">
                        ...
                        <tr>
                            <th scope="col" class="p-4">
                                <div class="flex items-center">
                                    <input id="checkbox-all" type="checkbox" class="w-4 h-4 text-primary-600 bg-gray-100 rounded border-gray-300 focus:ring-primary-500  focus:ring-2 ">
                    ...
                    <tbody data-accordion="table-column">
                        <tr class="border-b  hover:bg-gray-200  cursor-pointer transition" id="table-column-header-0" data-accordion-target="#table-column-body-0" aria-expanded="false" aria-controls="table-column-body-0">
                            <td class="px-4 py-3 w-4">
                                <div class="flex items-center">
                                    <input id="checkbox-table-search-1" type="checkbox" class="w-4 h-4 text-primary-600 bg-gray-100 rounded border-gray-300 focus:ring-primary-500">
                            ...
                            <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">Apple</td>
                            <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">$2999</td>
                            <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">200</td>
                        ...
                        <tr class="hidden flex-1 overflow-x-auto w-full" id="table-column-body-0" aria-labelledby="table-column-header-0">
                            <td class="p-4 border-b" colspan="9">
                                ...
                                <div>
                                    <h6 class="mb-2 text-base leading-none font-medium text-gray-900">Details</h6>
                                    <div class="text-base text-gray-500 max-w-screen-md">Standard glass, 3.8GHz 8-core 10th-generation Intel Core i7 processor, Turbo Boost up to 5.0GHz, 16GB 2666MHz DDR4 memory, Radeon Pro 5500 XT with 8GB of GDDR6 memory, 256GB SSD storage, Gigabit Ethernet, Magic Mouse 2, Magic Keyboard - US.</div>
                                </div>
                                <div class="grid grid-cols-4 gap-4 mt-4">
                                    <div class="relative p-3 bg-gray-100 rounded-lg flex flex-col items-start justify-between">
                                        <h6 class="mb-2 text-base leading-none font-medium text-gray-900">Product State</h6>
                                        <div class="bg-primary-100 text-primary-800 text-xs font-medium px-2.5 py-0.5 rounded-md flex items-center">
                                    ...
                                    <div class="relative p-3 bg-gray-100 rounded-lg flex flex-col justify-between">
                                        <h6 class="mb-2 text-base leading-none font-medium text-gray-900">Shipping</h6>
                                    ...
                                    <div class="relative p-3 bg-gray-100 rounded-lg">
                                        <h6 class="mb-2 text-base leading-none font-medium text-gray-900">Colors</h6>
                                    ...
                                    <div class="relative p-3 bg-gray-100 rounded-lg">
                                        <h6 class="mb-2 text-base leading-none font-medium text-gray-900">Brand</h6>
                                        <div class="flex items-center text-gray-500">Apple</div>
                                    </div>
                                    <div class="relative p-3 bg-gray-100 rounded-lg">
                                        <h6 class="mb-2 text-base leading-none font-medium text-gray-900">Sold by</h6>
                                        <div class="flex items-center text-gray-500">Flowbite</div>
                                    </div>
                                    <div class="relative p-3 bg-gray-100 rounded-lg">
                                        <h6 class="mb-2 text-base leading-none font-medium text-gray-900">Ships from</h6>
                                        <div class="flex items-center text-gray-500">Flowbite</div>
                                    </div>
                                    <div class="relative p-3 bg-gray-100 rounded-lg">
                                        <h6 class="mb-2 text-base leading-none font-medium text-gray-900">Dimensions (cm)</h6>
                                        <div class="flex items-center text-gray-500">105 x 15 x 23</div>
                                    </div>
                                    <div class="relative p-3 bg-gray-100 rounded-lg">
                                        <h6 class="mb-2 text-base leading-none font-medium text-gray-900">Item weight</h6>
                                        <div class="flex items-center text-gray-500">12kg</div>
                                    </div>
                                </div>
                                <div class="flex items-center space-x-3 mt-4">
                                    <button type="button" class="py-2 px-3 flex items-center text-sm font-medium text-center text-white bg-primary-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300">
                                    ...
                                    <button type="button" class="py-2 px-3 flex items-center text-sm font-medium text-center text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200">Preview</button>
                                    <button type="button" class="py-2 px-3 flex items-center text-sm font-medium text-center text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 rounded-lg">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">

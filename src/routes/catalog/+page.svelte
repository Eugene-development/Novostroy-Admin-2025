                ...
                <table class="w-full text-sm text-left text-gray-500 ">
                    <thead class="text-xs uppercase bg-gray-50 ">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3 min-w-[14rem]">Продукт</th>
                    ...
                    <tbody data-accordion="table-column">
                        ...
                        <tr class=" flex-1 overflow-x-auto w-full" id="table-column-body-0" aria-labelledby="table-column-header-0">
                            <td class="p-4 border-b" colspan="9">
                                ...
                                <div>
                                    <h6 class="mb-2 text-base leading-none font-medium text-gray-900">Описание</h6>
                                ...
                                <div class="grid grid-cols-4 gap-4 mt-4">
                                    <div class="relative p-3 bg-gray-100 rounded-lg flex flex-col items-start justify-between">
                                        <h6 class="mb-2 text-base leading-none font-medium text-gray-900">Статус</h6>
                                    ...
                                    <div class="relative p-3 bg-gray-100 rounded-lg flex flex-col justify-between">
                                        <h6 class="mb-2 text-base leading-none font-medium text-gray-900">Категория</h6>
                                    ...
                                    <div class="relative p-3 bg-gray-100 rounded-lg">
                                        <h6 class="mb-2 text-base leading-none font-medium text-gray-900">Теги</h6>
                                    ...
                                    <div class="relative p-3 bg-gray-100 rounded-lg">
                                        <h6 class="mb-2 text-base leading-none font-medium text-gray-900">Бренд</h6>
                                        <div class="flex items-center text-gray-500">Apple</div>
                                    </div>
                                    
                                </div>
                                <div class="flex items-center space-x-3 mt-4">
                                    <button type="button" class="py-2 px-3 flex items-center text-sm font-medium text-center text-gray-800 bg-primary-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300">
                                    ...
                                    <button type="button" class="py-2 px-3 flex items-center text-sm font-medium text-center text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200">Вернуть </button>

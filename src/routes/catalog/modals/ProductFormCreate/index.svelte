...
{#if visibleProductFormCreate.value}
	...
	-->
		...
		<div class="fixed inset-0 z-10 w-screen overflow-y-auto pt-8">
						...
						<div class="mb-4 grid gap-4 sm:grid-cols-2">
							...
							<div>
								...
								>
									...
									>
										User permissions, part of the overall user management process, are access
										granted to users to specific resources such as files, applications, networks, or
										devices.
							...
							{#if visibleFileCropperSection}
								...
								<button
									onclick={handleCrop}
									class="rounded bg-blue-500 px-4 py-2 font-bold text-white hover:bg-blue-700 {uploadStatus.loading
								...
								{#if uploadStatus.success}
									<div class="mt-2 text-green-500">Изображение успешно загружено!</div>
								{/if}
